...
class RegisterPage extends Page {
     ...
     */
    async register (NamaLengkap, Email, Username, Password, Confirm_Password, NoHP, Kota) {
        await this.inputNamaLengkap.setValue(NamaLengkap);
        await this.inputEmail.setValue(Email);
        await this.inputUsername.setValue(Username);
        await this.inputPassword.setValue(Password);
        await this.inputConfirmPassword.setValue(Confirm_Password);
        await this.inputNoHP.setValue(NoHP);
        await this.inputKota.setValue(Kota);
